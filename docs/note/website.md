...
- 前端开发所使用语言的主流学习资源汇集指南 - [作者: icepy](https://github.com/icepy) - [源](https://github.com/icepy/Front-End-Develop-Guide)
  ...
  <!--
    ...
    - 源 https://github.com/hawx1993/github-FE-project -->
...
- 适用于小团队的前端规范 - [作者: hzlzh](https://github.com/hzlzh) - [源](https://github.com/hzlzh/Front-End-Standards) - [阅读](http://front-end-standards.com/)
...
- [pandagif](www.pandagif.com/): 分类精细，多动漫类动图、清新舒服
...
- [Distill](https://distill.pub/):推特上活跃的领域大牛必须关注一波什么？
- [Google Scholar](https://scholar.google.com/)
- [ResearchGate](https://www.researchgate.net/)
- [DataTaudatatau.com](DataTaudatatau.com):专门给数据科学家看的 HackerNews。
...
- [JetPhotos](https://www.jetphotos.com/): 拍机党的最爱，JetPhotos 是全世界的爱拍机的飞友们交流靓照的地方，小编不拍机，但是禁不住众多飞友的熏陶，怕是又要入拍机坑了。
- [flightradar24](https://www.flightradar24.com/): FR24 大家都知道，不过还是想在这里说一下，小编第一次看到这个网站的时候只有一个感觉:酷炫。FR24 能够看到全世界的飞机位置，不知道原理的可以参考我原来的文章:雷达、应答机、 ADS-B 到底有什么区别。
- [luizmonteiro](http://www.luizmonteiro.com/): luizmonteiro 这个单词怎么读懵逼脸…不管怎么读，这个网站还是非常厉害的，提供了各类航空计算器，什么配载平衡、高度、温度换算等，另外，还提供了 VOR、ADF 等各类导航系统的模拟器，这个小编还不太会玩，求大神带。不懂 VOR 为何物的同学请参考我以前的文章:揭秘“飞机如何导航”。
- [skyvector](https://skyvector.com/): 对于 SkyVector，小编只能说:业界良心！全球的航图、飞行计划在线制定、NOTAM、机场信息、气象…几乎运营一家航空公司所需要的资料都可以找到，而且还是免费的！不过由于是国外的网站，对国内的资料的支持还是稍差一点。
- [通航云搜索](http://www.tonghangyun.com.cn/): 跟 SkyVector 的机场搜索类似，国内的这家通航云搜索信息也是非常详尽，特别是通航圈的小伙伴可以关注，小编最近用了几次，还不算完善但是也是国内独一份了。
- [飞常准-航线网络图](http://map.variflight.com/): 在飞常准的官网找到“航线网络图”就可以进入这个页面了，全球密密麻麻的航线实时更新着数据，有没有很震撼！不看不知道，原来每时每刻全世界都有 2 万+个航班在我们头顶飞着，民航系统庞大而有序。
- [自娱自乐航空迷-中国航图](https://yinlei.org/x-plane10/-aip-china.html)

## 汉字

- [Chineasy](https://www.chineasy.com/)设计很出色，充分利用汉字的优势，将汉字转换为一幅幅精美的图片，让识字变成一种享受。
- [造字](http://www.myfont.me): 用手写来造字
- [字里行间](https://zi.com/): 这是我目前见到的最美的中文写作 APP，开发者的设计功力非常强。
- [简书](http://www.jianshu.com/): 目前用的最多的写作 APP，干净，无广告，写作的好去处。
- [Medium]()如果发到国外平台，首推 Medium，一个非常优质的写作社区。
- [Bear](http://www.bear-writer.com/): 目前最常用的写作 APP，颜值极高。
- [Byword](https://metaclassy.com/): 简洁，优美，专注于文字。 -->
